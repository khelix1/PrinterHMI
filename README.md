...
Klipper/Moonraker print cell. The v6.5.4 firmware targets the ESP32-P4 based
- Firmware version: `6.5.3`
The v6.5.4 firmware targets the ESP32-P4 hosted display stack.
...
PrinterHMI v6.5.4 running on the JC1060P470C-I/W ESP32-P4 panel.
