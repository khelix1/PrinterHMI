...
This catalog reflects the v4.0.0 source list in `main/CMakeLists.txt`. Update it
...
| `thumbnail_session_v32`, `thumbnail_preview_coordinator_v32` | Selected-file session and preview coordination |
...
| `ui_printer_profiles`, `ui_printer_chooser_v32` | Profile editing and startup chooser |
...
| `ui_settings_popups`, `ui_ota_popup` | Settings confirmations and OTA UI |
| `ota_manager` | Persistent OTA URL, download task and reboot |
