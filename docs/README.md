...
Documents in this directory describe current v6.0.3 behavior unless they are
under `history/`.
...
- [`FULL_STACK_BUILD.md`](FULL_STACK_BUILD.md) — reproducible ESP-IDF 6.0.3 P4 and C6 firmware build
