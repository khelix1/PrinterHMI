...
lv_obj_t *ui_status_banner_v32_create(lv_obj_t *parent, int x, int y, int w, int h);
void ui_status_banner_v32_set(lv_obj_t *banner,
                              const char *state,
                              const char *file,
                              const char *eta,
                              const char *progress);
void ui_status_banner_v32_set_simple(lv_obj_t *banner,
                                     const char *state,
                                     const char *message);
