...
void ui_theme_c_apply_banner_status_style(lv_obj_t *obj, ui_status_kind_t kind);
...
void ui_theme_c_apply_button_status_style(lv_obj_t *obj, ui_status_kind_t kind);

void ui_theme_c_apply_label_primary(lv_obj_t *obj);
void ui_theme_c_apply_label_bright(lv_obj_t *obj);
void ui_theme_c_apply_label_dim(lv_obj_t *obj);
void ui_theme_c_apply_label_muted(lv_obj_t *obj);
void ui_theme_c_apply_label_success(lv_obj_t *obj);
void ui_theme_c_apply_label_warning(lv_obj_t *obj);
void ui_theme_c_apply_label_error(lv_obj_t *obj);

void ui_theme_c_apply_text_caption(lv_obj_t *obj);
void ui_theme_c_apply_text_body(lv_obj_t *obj);
void ui_theme_c_apply_text_body_large(lv_obj_t *obj);
void ui_theme_c_apply_text_button(lv_obj_t *obj);
void ui_theme_c_apply_text_value_small(lv_obj_t *obj);
void ui_theme_c_apply_text_title(lv_obj_t *obj);
void ui_theme_c_apply_text_dialog_title(lv_obj_t *obj);
void ui_theme_c_apply_text_popup_title(lv_obj_t *obj);
void ui_theme_c_apply_text_value(lv_obj_t *obj);
void ui_theme_c_apply_text_heading(lv_obj_t *obj);
void ui_theme_c_apply_text_percent(lv_obj_t *obj);
