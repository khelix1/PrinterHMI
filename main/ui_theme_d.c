                          ...
                          lv_opa_t glow_opacity)
{
    ...
    lv_obj_set_style_shadow_color(obj, UI_ACCENT_CYAN, 0);
                         ...
                         lv_color_t glow)
{
    ...
    lv_obj_set_style_shadow_color(obj, UI_ACCENT_BRIGHT, 0);
...
void ui_theme_d_apply_banner_status_style(lv_obj_t *obj,
                                          ui_status_kind_t kind)
{
    lv_color_t glow = ui_theme_d_status_color(kind);
...
void ui_theme_d_apply_info_box_style(lv_obj_t *obj)
{
    ...
    lv_obj_set_style_shadow_color(obj, UI_ACCENT_PURPLE, 0);
}
...
void ui_theme_d_apply_button_status_style(lv_obj_t *obj,
                                          ui_status_kind_t kind)
{
    switch (kind) {
        case UI_STATUS_OK:
            ui_theme_d_apply_button_success_style(obj);
            break;
        case UI_STATUS_WARNING:
            ui_theme_d_apply_button_warning_style(obj);
            break;
        case UI_STATUS_DANGER:
            ui_theme_d_apply_button_danger_style(obj);
            break;
        case UI_STATUS_NEUTRAL:
            ui_theme_d_apply_button_dark_style(obj);
            break;
        case UI_STATUS_INFO:
        case UI_STATUS_ACTIVE:
        default:
            ui_theme_d_apply_button_style(obj);
            break;
    }
}
...
#define THEME_C_DELEGATE_VOID(name)                    \
    void ui_theme_d_##name(lv_obj_t *obj)               \
    {                                                    \
